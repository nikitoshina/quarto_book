...
To develop effective survey questions, @krosnickQuestionnaireDesign2018
...
The sequence of questions in a survey can significantly impact responses
and respondent engagement. Here are some considerations:
...
surveys can impact data quality. Some considerations are:
...
In summary, survey designers should consider the specific research
goals, target population, and potential effects on response patterns
when deciding whether to include these response options in their
surveys.

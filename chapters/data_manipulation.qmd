...
The `filter()` function keeps only rows that satisfy specified criteria. Below, we use it to create two separate datasets for Males and Females. We use == for comparisons.

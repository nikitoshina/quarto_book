...
data <- readr::read_csv("https://raw.githubusercontent.com/nikitoshina/quarto_book/main/chapters/data/mexico_sample_data.csv")
read_csv("../mexico_sample_data.csv")
```
...
The dataset contains 114 rows and 7 columns, along with data types, detailing subjects' performances and choices in an experiment:
